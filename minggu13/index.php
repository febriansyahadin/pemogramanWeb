...
<body>
    <div class="container mt-4">
        <h2>Data Anggota</h2>
        <a class="btn btn-success mb-2" href="create.php">Tambah Data</a>
        <hr>
        <br>
        <?php
        include('koneksi.php');
                ...
                while ($row = sqlsrv_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger" data-toggle="modal" data-target="#hapusModal<?php echo $row["id"]; ?>">Hapus</button>
                        </td>
                    </tr>
                    <!-- Modal Hapus -->
